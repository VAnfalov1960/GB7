                  ...
                  <div class="col-sm-12">
                    <div class="top-banner-wrapper">
                      ...
                      <div class="top-banner-content small-section">
                        ...
                        <nuxt-link class="btn" :to="{ path: '/shop/dtdm'}">
                          <h5>ДТДМ</h5>
                        </nuxt-link>                        
                      </div>
                    </div>
                          ...
                          <div class="col-12">
                            <div class="product-filter-content">
                              ...
                              <div class="collection-view">
                                <!-- Кнопки сортировки в одну колонку или в несколько -->
                                <ul>
                                  <!-- <li @click="gridView()">
                              ...
                              <div class="product-page-filter">
                                <select @change="onChangeSort($event)">
                                  ...
                                  <option value="low">Цена: по возрастанию</option>
                                  <option value="high">Цена: по убыванию</option>
                                </select>
                              </div>
                            </div>
                          </div>
