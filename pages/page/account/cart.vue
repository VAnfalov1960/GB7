        ...
        <div class="row">
          <div class="col-sm-12">
              ...
              <tbody v-for="(item,index) in cart" :key="index">
                <tr>
                  ...
                  <td>
                    ...
                    <div class="mobile-cart-content row">
                      ...
                      <div class="col-xs-3">
                        <!-- <h2
                          class="td-color"
                        >{{ item.price * curr.curr | currency(curr.symbol) }} руб.</h2> -->
                        <h4 v-if="item.sale && item.discount > 0"
                      >{{ (item.price - (item.price * item.discount) / 100)* item.quantity * curr.curr }} руб.</h4>
                      <h4 v-if="!item.sale || item.discount == 0">{{ item.price * item.quantity * curr.curr }} руб.</h4>
                  ...
                  <td>
                      ...
                      >{{ (item.price - (item.price * item.discount) / 100) * curr.curr }} руб.</h4>
                      <h4 v-if="!item.sale || item.discount == 0">{{ item.price * curr.curr }} руб.</h4>
                  </td>
                  <td>
                    <div class="qty-box">
                      <div class="input-group">
                  ...
                  <td>
                    ...
                    <!-- <h2
                      class="td-color"
                    >{{ (item.price * curr.curr) * item.quantity | currency(curr.symbol) }} руб.</h2> -->
                  </td>
                </tr>
              </tbody>
            </table>
            <table class="table cart-table table-responsive-md" v-if="cart.length">
              <tfoot>
                <tr>
                  ...
                  <td>
                    <!-- РАЗОБРАТЬСЯ как взять cartTotal!!! -->
                    <!-- <h4>{{ cartTotal * curr.curr | currency(curr.symbol) }} руб.</h4> -->
                    <!-- <h4>{{ cartTotal * curr.curr  }} руб.</h4> -->
                    <h4>{{ cartTotal * curr.curr }} руб.</h4>
                  </td>
                </tr>
              </tfoot>
            ...
            <div class="col-sm-12 empty-cart-cls text-center" v-if="!cart.length">
              ...
              <div class="col-12">
                <nuxt-link :to="{ path: '/collection/leftsidebar/'}" class="btn btn-solid" style="border: 1px solid white; border-radius: 40px">Продолжить покупки</nuxt-link>
              </div>
            </div>
          </div>
        </div>
