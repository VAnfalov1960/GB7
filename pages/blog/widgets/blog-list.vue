    ...
    >
      ...
      <div class="col-xl-6">
        <div class="blog-left">
          ...
          <div>
            <!-- <h6>{{ blog.date }}</h6> -->
            <a target="_blank" :href="blog.src1">
              <h4>{{blog.title}}</h4>
            </a>
            <!-- <nuxt-link :to="{ path: '/blog/blog-detail'}">
              <h4>{{blog.title}}</h4>
            ...
            <!-- <ul class="post-social">
              <li>Опубликовано: {{blog.auther}}</li>
              <li>
                <i class="fa fa-heart"></i> 5 хит
              </li>
              <li>
                <i class="fa fa-comments"></i> 10 комментариев
              </li>
            </ul>-->
