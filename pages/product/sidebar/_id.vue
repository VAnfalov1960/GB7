              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6">
                    <div v-swiper:mySwiper="swiperOption" ref="mySwiper">
                      <div class="swiper-wrapper">
                        ...
                        >
                          ...
                          />
                          <a
                            v-if="getDetail.documentation"
                            :href="getDetail.documentation"
                            target="_blank"
                            class="btn btn-solid mr-3"
                            style="border: 1px solid white; border-radius: 40px; width: 95%"
                          >Документация</a>
                          <br />
                          <br />
                        </div>
                    ...
                    <div v-if="getDetail.date_title" class="border-product" style="margin-top: 10px; border: 1px solid grey; border-radius: 10px; padding-top: 10px;">
                      <h5 style="margin-left: 40px" class="product-title">{{ getDetail.date_title }}</h5>
                      <Timer style="margin-top: -40px" :date="getDetail.date" />
                    </div>
                  </div>
                  <div class="col-lg-6 rtl-text">
                    <div class="product-right">
                      <h3>{{ getDetail.title }}</h3>
                      <p>Код продукта: {{ getDetail.id }}</p>
                      <br />
                      ...
                      <div v-if="getDetail.price >= 0">          
                        ...
                        <h4 v-if="getDetail.sale && getDetail.discount > 0">
                          <del>{{ getDetail.price }} руб.</del> - cкидка сайта {{ getDetail.discount }}%
                        </h4>
                        <div>
                          <h4 v-if="getDetail.promo > 0">
                          + 10% кэшбек по промокоду: {{ getDetail.promo }}.
                          </h4>
                          <nuxt-link target="_blank"
                            :to="{ path: '/page/account/contact'}" title="Контактная информация">
                          <h6 v-if="(getDetail.brand == 'Инфоурок')">Предусмотрена дополнительная скидка 25%.</h6>
                          <h6 v-if="(getDetail.brand == 'Инфоурок')">Все вопросы к администратору этого сайта через контактную форму или по телефону.</h6></nuxt-link>
                            <br>
                        </div>
                        ...
                        <div class="pro_inventory" v-if="getDetail.allstudents">
                          <!-- Не пойму почему красная, а работает нормально???  -->
                          <!-- Как экранировать знак > ??? -->
                          <p
                        ...
                        <div v-if="counter > 0">                        
                          <h3 v-if="getDetail.sale">
                            {{ discountedPrice(getDetail) * counter * curr.curr | currency(curr.symbol) }} руб.</h3>
                          <h3
                            v-else>{{ getDetail.price * counter * curr.curr | currency(curr.symbol) }} руб.
                          </h3>
                        </div>
                        ...
                        <nuxt-link target="_blank"
                          :to="{ path: '/page/account/contact'}" title="Контактная информация<"
                        ><h6 v-if="((getDetail.price * counter * curr.curr) > 0) && (getDetail.brand == 'Инфоурок')"> Стоимость <span style="color: red">ОБЯЗАТЕЛЬНО</span> уточняйте у администратора ЭТОГО сайта.
                        </h6>
                        </nuxt-link>    
                           
                        <br v-if="(getDetail.price * counter * curr.curr) == 0" />
                        <br v-if="(getDetail.price * counter * curr.curr) > 0" />
                        <br v-if="(getDetail.price * counter * curr.curr) > 0" />
                      ...
                      <div class="border-product">
                        <!-- <h6 class="product-title">Поделись этим</h6> -->
                        <div class="product-icon">
                          <!-- <ul class="product-social">
                            <li v-if="(getDetail.src_facebook )">
                              <a href="javascript:void(0)">
                                <i class="fa fa-facebook"></i>
                              </a>
                            </li>
                            <li v-if="(getDetail.src_google-plus )">
                              <a href="javascript:void(0)">
                                <i class="fa fa-google-plus"></i>
                              </a>
                            </li>
                            <li v-if="(getDetail.src_twitter )">
                              <a href="javascript:void(0)">
                                <i class="fa fa-twitter"></i>
                              </a>
                            </li>
                            <li v-if="(getDetail.src_instagram )">
                              <a href="javascript:void(0)">
                                <i class="fa fa-instagram"></i>
                              </a>
                            </li>
                            <li v-if="(getDetail.src_rss )">
                              <a href="javascript:void(0)">
                                <i class="fa fa-rss"></i>
                              </a>
                            </li>
                          ...
                          <!-- <form class="d-inline-block">
                            <button class="wishlist-btn" @click="addToWishlist(product.id)">
                              ...
                              <span class="title-font">Добавить в список желаний</span>
                            </button>
                          </form> -->
                        </div>
                      </div>
                      <!-- <div class="border-product">
                        <h5 class="product-title">Информация о продукте</h5>
                ...
                <div class="row">
                  <div class="col-sm-12 col-lg-12">
                    <b-tabs card>
                      ...
                      <b-tab title="Фотогаллерея">

                      </b-tab>                      
                      <b-tab title="Видео">
                        <b-card-text>
                          <div class="mt-6 text-center">
                            <iframe v-if="getDetail.video_dzen_src" width="480" height="270" :src="getDetail.video_dzen_src" frameborder="0" scrolling="no" allowfullscreen=""></iframe>
                            <h4 v-if="getDetail.title1src" >{{ getDetail.title1src }}</h4>
                            <video-embed v-if="getDetail.video1src"
                             player-width="300"
                              player-height="200"
                              ref="youtube"
                              :params="{autoplay: 0}"
                            ...
                            <video-embed v-if="getDetail.video2src"
                              player-width="300"
                              player-height="200"
                              ref="youtube"
                              :params="{autoplay: 0}"
                            ...
                            <video-embed v-if="getDetail.video3src"
                              player-width="300"
                              player-height="200"
                              ref="youtube"
                              :params="{autoplay: 0}"
                            ...
                            <video-embed v-if="getDetail.video4src"
                              player-width="300"
                              player-height="200"
                              ref="youtube"
                              :params="{autoplay: 0}" 
                            ...
                            <video-embed v-if="getDetail.video5src"
                              player-width="300"
                              player-height="200"
                              ref="youtube"
                              :params="{autoplay: 0}" 
                            ...
                            <h4 v-if="getDetail.video_start_title  && getDetail.video_start" >{{ getDetail.video_start_title }}</h4>
                            <a
                            ...
                            <br v-if="getDetail.video_z1_title && getDetail.video_z1"  /> 
                            <h4 v-if="getDetail.video_z1_title  && getDetail.video_z1" >{{ getDetail.video_z1_title }}</h4>
                            <a
                              v-if="getDetail.video_z1"
                              :href="getDetail.video_z1"
                              target="_blank"
                            ><img
                            ...
                            <br v-if="getDetail.video_z2_title && getDetail.video_z2"  /> 
                            <h4 v-if="getDetail.video_z2_title  && getDetail.video_z2" >{{ getDetail.video_z2_title }}</h4>
                            <a
                              v-if="getDetail.video_z2"
                              :href="getDetail.video_z2"
                              target="_blank"
                            ><img
                            ...
                            <br v-if="getDetail.video_z3_title && getDetail.video_z3"  /> 
                            <h4 v-if="getDetail.video_z3_title  && getDetail.video_z3" >{{ getDetail.video_z3_title }}</h4>
                            <a
                              v-if="getDetail.video_z3"
                              :href="getDetail.video_z3"
                              target="_blank"
                            ><img
                            ...
                            <br v-if="getDetail.video_z4_title && getDetail.video_z4"  /> 
                            <h4 v-if="getDetail.video_z4_title  && getDetail.video_z4" >{{ getDetail.video_z4_title }}</h4>
                            <a
                              v-if="getDetail.video_z4"
                              :href="getDetail.video_z4"
                              target="_blank"
                            ><img
                            ...
                            <br v-if="getDetail.video_end_title && getDetail.video_end"  /> 
                            <h4 v-if="getDetail.video_end_title  && getDetail.video_end" >{{ getDetail.video_end_title }}</h4>
                            <a
                      ...
                      <b-tab title="Написать отзыв">
                        <b-card-text>
                          <form action="../../../../form/mail-review.php" target="_blank" method="POST" class="theme-form">
                            <div class="form-row">
                              <div class="col-md-12">
                                <div class="media">
                                  <label>Рейтинг</label>
    ...
    <!-- <section v-if="getDetail.brand == 'Инфоурок'" class="section-b-space">
      ...
      <div class="container">
        ...
        >
          ...
          <div class="col-md-6">
            <div class="timer-box" style="margin-top: 50px">
              <countdown :date="getDetail.date2"></countdown>
            </div>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        certificate_src1001: require("@/assets/images/certificate/1001.jpg"),
