    ...
    <div class="collection-filter" :class="{'openFilterbar' : filter}">
      <div class="collection-filter-block">
        ...
        <div class="collection-collapse-block" :class="{ open: openBlock }">
          <h3>Убрать его отсюда/ Это - product-silebar.vue</h3>
          <h3 class="collapse-block-title" @click="toggleSidebarBlock()">Категория</h3>
          <div class="collection-collapse-block-content">
            <div class="collection-brand-filter">
              <ul class="category-list">
                <li>
                  <nuxt-link :to="{ path: '/collection/leftsidebar/all'}">Все продукты</nuxt-link>
                </li>
      ...
      <!-- <div class="collection-filter-block">
        <div class="product-service">
          ...
          <div class="media">
            ...
            <div class="media-body">
              <h4>Обслуживание 24 X 7</h4>
              <p>Онлайн-сервис для новых клиентов</p>
            </div>
          </div>
          <div class="media">
            ...
            <div class="media-body">
              <h4>Предложение фестиваля</h4>
              <p>Новое специальное предложение фестиваля онлайн</p>
            </div>
          </div>
          <div class="media border-0 m-0">
            ...
            <div class="media-body">
              <h4>Онлайн-оплата</h4>
              <p>Вопреки распространенному мнению.</p>
            </div>
          </div>
        </div>
      </div>-->
