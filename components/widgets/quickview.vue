        ...
        <div class="col-lg-6 rtl-text">
          <div class="product-right">
            ...
            <h3 v-if="productData.sale">
              {{ discountedPrice(productData) * curr.curr | currency(curr.symbol) }} руб.
              <del>{{ productData.price * curr.curr | currency(curr.symbol) }} руб.</del>
            </h3>
            <h3 v-else>{{ productData.price * curr.curr | currency(curr.symbol) }} руб.</h3>
            ...
            <div class="product-description border-product" v-if="productData.variants[0].size">
              <h6 class="product-title">Выберите размер</h6>
              <div class="size-box">
                <ul>
                  <li
                    v-for="(variant,variantIndex) in Size(productData.variants)"
                    :key="variantIndex"
                  >
            ...
            <div class="border-product">
              <h6 class="product-title">Подробная информация о продукте</h6>
