  ...
  <div>
    <div class="img-wrapper">
      ...
      <div class="cart-info cart-wrap">
        ...
        <a href="javascript:void(0)" title="Список желаний">
    ...
    <div class="product-detail" style="width: 100%; height: 200px;">
      <div class="rating">
      ...
      <h4 v-if="product.sale">
        {{ discountedPrice(product) * curr.curr | currency(curr.symbol) }} руб.<br />
        <del>{{ product.price * curr.curr | currency(curr.symbol) }} руб.</del>
      </h4>
      <h4 v-else>{{ product.price * curr.curr | currency(curr.symbol) }} руб</h4>
